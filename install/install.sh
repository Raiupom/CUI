#!/bin/sh
# This script installs CUI.
#
# Found a bug? Report it here: https://github.com/Raiupom/CUI/issues

set -e -u

eval "git clone 'https://github.com/Raiupom/CUI.git'"

cd CUI

echo "CUI cloned! Installing dependencies..."
...
CUI has been downloaded to the current directory.
